...
//private:
//
//    std::vector<std::unique_ptr<CADIFrameResource>> mFrameResources;
//    CADIFrameResource* mCurrFrameResource = nullptr;
...
//	};
//
//	mShaders["standardVS"] = d3dUtil::CompileShader(L"E:\\DX12Book\\DX12LearnProject\\DX12Learn\\LearnDemo\\Chapter 15 First Person Camera and Dynamic Indexing\\CameraAndDynamicIndexing\\Shaders\\Default.hlsl", nullptr, "VS", "vs_5_1");
//	mShaders["opaquePS"] = d3dUtil::CompileShader(L"E:\\DX12Book\\DX12LearnProject\\DX12Learn\\LearnDemo\\Chapter 15 First Person Camera and Dynamic Indexing\\CameraAndDynamicIndexing\\Shaders\\Default.hlsl", nullptr, "PS", "ps_5_1");
//	
//    mInputLayout =
//    {
...
//    {
//        mFrameResources.push_back(std::make_unique<CADIFrameResource>(md3dDevice.Get(),
