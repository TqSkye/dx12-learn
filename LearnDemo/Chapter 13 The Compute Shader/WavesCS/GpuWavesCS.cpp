...
GpuWavesCS::GpuWavesCS(ID3D12Device* device, ID3D12GraphicsCommandList* cmdList,
...
UINT GpuWavesCS::RowCount()const
{
	return mNumRows;
}

UINT GpuWavesCS::ColumnCount()const
{
	return mNumCols;
}

UINT GpuWavesCS::VertexCount()const
{
	return mVertexCount;
}

UINT GpuWavesCS::TriangleCount()const
{
	return mTriangleCount;
}

float GpuWavesCS::Width()const
{
	return mNumCols*mSpatialStep;
}

float GpuWavesCS::Depth()const
{
	return mNumRows*mSpatialStep;
}

float GpuWavesCS::SpatialStep()const
{
	return mSpatialStep;
}

CD3DX12_GPU_DESCRIPTOR_HANDLE GpuWavesCS::DisplacementMap()const
{
	return mCurrSolSrv;
}

UINT GpuWavesCS::DescriptorCount()const
{
	// Number of descriptors in heap to reserve for GpuWaves.
	return 6;
}

void GpuWavesCS::BuildResources(ID3D12GraphicsCommandList* cmdList)
{
...
void GpuWavesCS::BuildDescriptors(
