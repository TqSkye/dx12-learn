...
public:
    ...
    GpuWavesCS(ID3D12Device* device, ID3D12GraphicsCommandList* cmdList, int m, int n, float dx, float dt, float speed, float damping);
    GpuWavesCS(const GpuWavesCS& rhs) = delete;
    GpuWavesCS& operator=(const GpuWavesCS& rhs) = delete;
	~GpuWavesCS()=default;
