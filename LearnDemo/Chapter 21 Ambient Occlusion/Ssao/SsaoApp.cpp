...
// ╡н©╪ндуб: https://zhuanlan.zhihu.com/p/46633896
//          https://zhuanlan.zhihu.com/p/683050652
...
private:
    ...
    std::vector<std::unique_ptr<SsaoFrameResource>> mFrameResources;
    SsaoFrameResource* mCurrFrameResource = nullptr;
    ...
    std::unique_ptr<SsaoShadowMap> mShadowMap;
...
bool SsaoApp::Initialize()
{
    ...
    mShadowMap = std::make_unique<SsaoShadowMap>(md3dDevice.Get(),
        2048, 2048);
...
void SsaoApp::LoadTextures()
{
    ...
    std::vector<std::wstring> texFilenames =
    {
        ...
        L"E:/DX12Book/DX12LearnProject/DX12Learn/Textures/sunsetcube1024.dds"
    };
...
void SsaoApp::BuildShadersAndInputLayout()
{
	...
	mShaders["standardVS"] = d3dUtil::CompileShader(L"E:\\DX12Book\\DX12LearnProject\\DX12Learn\\LearnDemo\\Chapter 21 Ambient Occlusion\\Ssao\\Shaders\\Default.hlsl", nullptr, "VS", "vs_5_1");
	mShaders["opaquePS"] = d3dUtil::CompileShader(L"E:\\DX12Book\\DX12LearnProject\\DX12Learn\\LearnDemo\\Chapter 21 Ambient Occlusion\\Ssao\\Shaders\\Default.hlsl", nullptr, "PS", "ps_5_1");

    mShaders["shadowVS"] = d3dUtil::CompileShader(L"E:\\DX12Book\\DX12LearnProject\\DX12Learn\\LearnDemo\\Chapter 21 Ambient Occlusion\\Ssao\\Shaders\\Shadows.hlsl", nullptr, "VS", "vs_5_1");
    mShaders["shadowOpaquePS"] = d3dUtil::CompileShader(L"E:\\DX12Book\\DX12LearnProject\\DX12Learn\\LearnDemo\\Chapter 21 Ambient Occlusion\\Ssao\\Shaders\\Shadows.hlsl", nullptr, "PS", "ps_5_1");
    mShaders["shadowAlphaTestedPS"] = d3dUtil::CompileShader(L"E:\\DX12Book\\DX12LearnProject\\DX12Learn\\LearnDemo\\Chapter 21 Ambient Occlusion\\Ssao\\Shaders\\Shadows.hlsl", alphaTestDefines, "PS", "ps_5_1");
	
    mShaders["debugVS"] = d3dUtil::CompileShader(L"E:\\DX12Book\\DX12LearnProject\\DX12Learn\\LearnDemo\\Chapter 21 Ambient Occlusion\\Ssao\\Shaders\\ShadowDebug.hlsl", nullptr, "VS", "vs_5_1");
    mShaders["debugPS"] = d3dUtil::CompileShader(L"E:\\DX12Book\\DX12LearnProject\\DX12Learn\\LearnDemo\\Chapter 21 Ambient Occlusion\\Ssao\\Shaders\\ShadowDebug.hlsl", nullptr, "PS", "ps_5_1");

    mShaders["drawNormalsVS"] = d3dUtil::CompileShader(L"E:\\DX12Book\\DX12LearnProject\\DX12Learn\\LearnDemo\\Chapter 21 Ambient Occlusion\\Ssao\\Shaders\\DrawNormals.hlsl", nullptr, "VS", "vs_5_1");
    mShaders["drawNormalsPS"] = d3dUtil::CompileShader(L"E:\\DX12Book\\DX12LearnProject\\DX12Learn\\LearnDemo\\Chapter 21 Ambient Occlusion\\Ssao\\Shaders\\DrawNormals.hlsl", nullptr, "PS", "ps_5_1");

    mShaders["ssaoVS"] = d3dUtil::CompileShader(L"E:\\DX12Book\\DX12LearnProject\\DX12Learn\\LearnDemo\\Chapter 21 Ambient Occlusion\\Ssao\\Shaders\\Ssao.hlsl", nullptr, "VS", "vs_5_1");
    mShaders["ssaoPS"] = d3dUtil::CompileShader(L"E:\\DX12Book\\DX12LearnProject\\DX12Learn\\LearnDemo\\Chapter 21 Ambient Occlusion\\Ssao\\Shaders\\Ssao.hlsl", nullptr, "PS", "ps_5_1");

    mShaders["ssaoBlurVS"] = d3dUtil::CompileShader(L"E:\\DX12Book\\DX12LearnProject\\DX12Learn\\LearnDemo\\Chapter 21 Ambient Occlusion\\Ssao\\Shaders\\SsaoBlur.hlsl", nullptr, "VS", "vs_5_1");
    mShaders["ssaoBlurPS"] = d3dUtil::CompileShader(L"E:\\DX12Book\\DX12LearnProject\\DX12Learn\\LearnDemo\\Chapter 21 Ambient Occlusion\\Ssao\\Shaders\\SsaoBlur.hlsl", nullptr, "PS", "ps_5_1");

	mShaders["skyVS"] = d3dUtil::CompileShader(L"E:\\DX12Book\\DX12LearnProject\\DX12Learn\\LearnDemo\\Chapter 21 Ambient Occlusion\\Ssao\\Shaders\\Sky.hlsl", nullptr, "VS", "vs_5_1");
	mShaders["skyPS"] = d3dUtil::CompileShader(L"E:\\DX12Book\\DX12LearnProject\\DX12Learn\\LearnDemo\\Chapter 21 Ambient Occlusion\\Ssao\\Shaders\\Sky.hlsl", nullptr, "PS", "ps_5_1");
...
{
    std::ifstream fin("E:/DX12Book/DX12LearnProject/DX12Learn/LearnDemo/Chapter 21 Ambient Occlusion/Ssao/Models/skull.txt");

    if (!fin)
    {
        MessageBox(0, L"E:/DX12Book/DX12LearnProject/DX12Learn/LearnDemo/Chapter 21 Ambient Occlusion/Ssao/Models/skull.txt not found.", 0, 0);
        return;
    }
...
void SsaoApp::BuildFrameResources()
{
    ...
    {
        mFrameResources.push_back(std::make_unique<SsaoFrameResource>(md3dDevice.Get(),
