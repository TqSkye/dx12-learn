...
{
public:
    BlendWaves(int m, int n, float dx, float dt, float speed, float damping);
    BlendWaves(const BlendWaves& rhs) = delete;
    BlendWaves& operator=(const BlendWaves& rhs) = delete;
    ~BlendWaves();
