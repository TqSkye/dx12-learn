...
//#include "TexColumnsFrameResource.h"
//
...
//private:
//
//    std::vector<std::unique_ptr<TexColumnsFrameResource>> mFrameResources;
//    TexColumnsFrameResource* mCurrFrameResource = nullptr;
...
//    // 创建具有4个槽位的根签名，第一个指向含有单个着色器资源视图的描述符表，其他3个各指向一个常量缓冲区视图
...
//	};
//
//	mShaders["standardVS"] = d3dUtil::CompileShader(L"E:\\DX12Book\\DX12LearnProject\\DX12Learn\\LearnDemo\\Chapter 9 Texturing\\TexColumns\\Shaders\\Default.hlsl", nullptr, "VS", "vs_5_0");
//	mShaders["opaquePS"] = d3dUtil::CompileShader(L"E:\\DX12Book\\DX12LearnProject\\DX12Learn\\LearnDemo\\Chapter 9 Texturing\\TexColumns\\Shaders\\Default.hlsl", nullptr, "PS", "ps_5_0");
//	
//    mInputLayout =
//    {
...
//    {
//        mFrameResources.push_back(std::make_unique<TexColumnsFrameResource>(md3dDevice.Get(),
...
//		D3D12_FILTER_MIN_MAG_MIP_POINT, // filter 过滤器类型
...
//		1, // shaderRegister 着色器寄存器
//		D3D12_FILTER_MIN_MAG_MIP_POINT, // filter 过滤器类型
//		D3D12_TEXTURE_ADDRESS_MODE_CLAMP,  // addressU U轴方向上所用的寻址模式
//		D3D12_TEXTURE_ADDRESS_MODE_CLAMP,  // addressV V轴方向上所用的寻址模式
//		D3D12_TEXTURE_ADDRESS_MODE_CLAMP); // addressW W轴方向上所用的寻址模式
//
//	const CD3DX12_STATIC_SAMPLER_DESC linearWrap(
//		2, // shaderRegister 着色器寄存器
//		D3D12_FILTER_MIN_MAG_MIP_LINEAR, // filter 过滤器类型
//		D3D12_TEXTURE_ADDRESS_MODE_WRAP,  // addressU U轴方向上所用的寻址模式
//		D3D12_TEXTURE_ADDRESS_MODE_WRAP,  // addressV V轴方向上所用的寻址模式
//		D3D12_TEXTURE_ADDRESS_MODE_WRAP); // addressW W轴方向上所用的寻址模式
//
//	const CD3DX12_STATIC_SAMPLER_DESC linearClamp(
//		3, // shaderRegister 着色器寄存器
//		D3D12_FILTER_MIN_MAG_MIP_LINEAR, // filter 过滤器类型
//		D3D12_TEXTURE_ADDRESS_MODE_CLAMP,  // addressU U轴方向上所用的寻址模式
//		D3D12_TEXTURE_ADDRESS_MODE_CLAMP,  // addressV V轴方向上所用的寻址模式
//		D3D12_TEXTURE_ADDRESS_MODE_CLAMP); // addressW W轴方向上所用的寻址模式
...
//		4, // shaderRegister 着色器寄存器
//		D3D12_FILTER_ANISOTROPIC, // filter 过滤器类型
//		D3D12_TEXTURE_ADDRESS_MODE_WRAP,  // addressU U轴方向上所用的寻址模式
//		D3D12_TEXTURE_ADDRESS_MODE_WRAP,  // addressV V轴方向上所用的寻址模式
//		D3D12_TEXTURE_ADDRESS_MODE_WRAP,  // addressW W轴方向上所用的寻址模式
