...
//private:
//
//    std::vector<std::unique_ptr<IACFrameResource>> mFrameResources;
//    IACFrameResource* mCurrFrameResource = nullptr;
...
//	};
//
//	mShaders["standardVS"] = d3dUtil::CompileShader(L"E:\\DX12Book\\DX12LearnProject\\DX12Learn\\LearnDemo\\Chapter 16 Instancing and Frustum Culling\\InstancingAndCulling\\Shaders\\Default.hlsl", nullptr, "VS", "vs_5_1");
//	mShaders["opaquePS"] = d3dUtil::CompileShader(L"E:\\DX12Book\\DX12LearnProject\\DX12Learn\\LearnDemo\\Chapter 16 Instancing and Frustum Culling\\InstancingAndCulling\\Shaders\\Default.hlsl", nullptr, "PS", "ps_5_1");
//	
//    mInputLayout =
//    {
...
//{
//	std::ifstream fin("E:/DX12Book/DX12LearnProject/DX12Learn/LearnDemo/Chapter 16 Instancing and Frustum Culling/InstancingAndCulling/Models/skull.txt");
//
//	if(!fin)
//	{
//		MessageBox(0, L"E:/DX12Book/DX12LearnProject/DX12Learn/LearnDemo/Chapter 16 Instancing and Frustum Culling/InstancingAndCulling/Models/skull.txt not found.", 0, 0);
//		return;
//	}
//
//	UINT vcount = 0;
...
//    {
//        mFrameResources.push_back(std::make_unique<IACFrameResource>(md3dDevice.Get(),
