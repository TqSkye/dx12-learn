...
//#include "FrameResourceLitColumns.h"
//
...
//	// Because we have an object cbuffer for each FrameResourceLitColumns, we have to apply the
//	// update to each FrameResourceLitColumns.  Thus, when we modify obect data we should set 
...
//private:
//
//    std::vector<std::unique_ptr<FrameResourceLitColumns>> mFrameResources;
//    FrameResourceLitColumns* mCurrFrameResource = nullptr;
...
//
//			// Next FrameResourceLitColumns need to be updated too.
//			e->NumFramesDirty--;
//		}
//	}
//}
...
//		// data changes, it needs to be updated for each FrameResourceLitColumns.
...
//	};
//
//	mShaders["standardVS"] = d3dUtil::CompileShader(L"E:\\DX12Book\\DX12LearnProject\\DX12Learn\\LearnDemo\\LitColumns\\Shaders\\Default.hlsl", nullptr, "VS", "vs_5_1");
//	mShaders["opaquePS"] = d3dUtil::CompileShader(L"E:\\DX12Book\\DX12LearnProject\\DX12Learn\\LearnDemo\\LitColumns\\Shaders\\Default.hlsl", nullptr, "PS", "ps_5_1");
//	
//    mInputLayout =
//    {
...
//{
//	std::ifstream fin("E:/DX12Book/DX12LearnProject/DX12Learn/LearnDemo/LitColumns/Models/skull.txt");
//
//	if(!fin)
//	{
//		MessageBox(0, L"E:/DX12Book/DX12LearnProject/DX12Learn/LearnDemo/LitColumns/Models/skull.txt not found.", 0, 0);
//		return;
//	}
//
//	UINT vcount = 0;
...
//    {
//        mFrameResources.push_back(std::make_unique<FrameResourceLitColumns>(md3dDevice.Get(),
