...
public:
    ...
    AnimSsao(ID3D12Device* device,
        ID3D12GraphicsCommandList* cmdList, 
        UINT width, UINT height);
    AnimSsao(const AnimSsao& rhs) = delete;
    AnimSsao& operator=(const AnimSsao& rhs) = delete;
    ~AnimSsao() = default;
...
private:
    ...
    ///</summary>
    void BlurAmbientMap(ID3D12GraphicsCommandList* cmdList, AnimFrameResource* currFrame, int blurCount);
